...
import styles from './TooltipLink.css';

export default class TooltipLink extends Component {
  ...
  render() {
    ...
    return (
      <div className={styles.container}>
        ...
        <button
          className={'_blank' === target ? `${styles.button} ${styles.active}` : styles.button}
        ...
        <button
          className={nofollow ? `${styles.button} ${styles.active}` : styles.button}
